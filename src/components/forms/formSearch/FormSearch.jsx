...
class FormSearch extends Component {
  ...
  handleCheckedRiskFactors = ({ target: { checked } }) => {
    const sContext = this.state.searchContext;
    sContext.targetSearchEntitiesContext.onlyMonlyWithRiskFactorsinRole =
      checked;
    this.setState({
      searchContext: sContext,
    });
  ...
  getData = (e) => {
    e.preventDefault();
    const innText =
      this.state.searchContext.targetSearchEntitiesContext
    ...
    if (this.state.dataOutput) {
      return (
        <Output
          ...
          exRequest={this.state.exRequest}
        />
      );
    } else
      return (
            ...
            <div className="container">
              <div className={styles.page__search}>
                <div className={styles.search__content}>
                  ...
                  <div className={styles.img__doc}>
                    <img
                      src={imgDoc}
                      alt="Document"
                      className={styles.img__doc}
                    />
                    <img
                      src={imgFolders}
                      className={styles.img__folders}
                      alt="Folders"
                    />
                  </div>
                </div>
                ...
                <div className={styles.block__form_search}>
                  <form
                    className={stylesF.form__search}
                    onSubmit={this.getData}
                  >
                    <div>
                      <label htmlFor="" className={stylesF.label}>
                        ИНН компании *
                      </label>
                      <input
                        type="number"
                        ...
                        className={
                          this.errorInn
                            ? stylesF.input + ' ' + stylesF.input__required
                            : stylesF.input
                        }
                        name="inn"
                        value={inn}
                      ...
                      />
                      <p className={stylesF.text__error}>
                        {this.errorInn && this.errTextForInn}
                      </p>
                      ...
                      <select
                        className={stylesF.select__tonality}
                        name="tonality"
                      ...
                      />
                      <p className={stylesF.text__error}>
                        {this.errorLimit && this.errTextForLimit}
                      </p>
                      ...
                      <input
                        ...
                        className={stylesF.input + ' ' + stylesF.input__data}
                    ...
                    <div className={stylesF.checkbox__mobile}>
                      ...
                      <div className={stylesF.list__checkbox}>
                        <input
                          type="checkbox"
                          onChange={this.handleCheckedMainRole}
                        />
                        <span className={stylesF.span}>
                      ...
                      <div className={stylesF.list__checkbox}>
                        <input
                          type="checkbox"
                          onChange={this.handleCheckedRiskFactors}
                          disabled
                        />
                        <span
                          className={
                            stylesF.span + ' ' + stylesF.span__disabled
                          }
                        >
                      ...
                      <div>
                        ...
                        <p className={stylesF.button__text}>
