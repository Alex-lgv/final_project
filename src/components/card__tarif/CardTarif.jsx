        ...
        <div className={styles.card__content}>
          <div className={styles.cards__grid}>
            <div className={styles.card}>
              <div
                className={
                  styles.card__background + ' ' + styles.background__oranje
                }
              >
                <div>
              ...
              <div className={styles.card__price}>
                <span className={styles.price__now}>799 ₽</span>
                <span className={styles.price__outdated}>1 200 ₽</span>
                ...
                <div className={styles.checkmark}>
                  ...
                  <span className={styles.checkmark__text}>
                ...
                <div className={styles.checkmark}>
                  <img src={iconCheckmark} alt="Checkmark" />
                  <span className={styles.checkmark__text}>Поддержка 24/7</span>
                </div>
              </div>
              <div className={styles.button}>
                <button type="button" className={styles.button__tarif}>
                  Подробнее
                </button>
              </div>
            </div>
            <div className={styles.card}>
              <div
                className={
                  styles.card__background + ' ' + styles.background__blue
                }
              >
                <div>
              ...
              <div className={styles.card__price}>
                <span className={styles.price__now}>1 299 ₽</span>
                <span className={styles.price__outdated}>2 600 ₽</span>
                <p className={styles.add__text}>
            ...
            <div className={styles.card}>
              <div
                className={
                  styles.card__background + ' ' + styles.background__black
                }
              >
                <div>
                  <h3 className={styles.heading + ' ' + styles.color}>
                    Business
                  </h3>
                  <p className={styles.text + ' ' + styles.color}>
              ...
              <div className={styles.card__price}>
                <span className={styles.price__now}>2 379 ₽</span>
                <span className={styles.price__outdated}>3 700 ₽</span>
                <p className={styles.add__text + ' ' + styles.with__empty}>
                  или 279 ₽/мес. при рассрочке на 24 мес.
                </p>
                <p className={styles.services__text}>В тариф входит:</p>
                <div className={styles.checkmark}>
